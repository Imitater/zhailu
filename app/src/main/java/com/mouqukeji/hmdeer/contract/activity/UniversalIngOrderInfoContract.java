...
public interface UniversalIngOrderInfoContract {
    ...
    abstract class Presenter extends BasePresenter<UniversalIngOrderInfoContract.View, UniversalIngOrderInfoContract.Model> {
