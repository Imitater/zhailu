...
public interface ReChargeContract {
    ...
    abstract class Presenter extends BasePresenter<ReChargeContract.View, ReChargeContract.Model> {
        ...
        public abstract void reChargePage(MultipleStatusView multipleStatusView);
    }
}
