...
public interface DeliverIngOrderInfoContract {
    ...
    abstract class Presenter extends BasePresenter<DeliverIngOrderInfoContract.View, DeliverIngOrderInfoContract.Model> {
