package com.mouqukeji.hmdeer.service;
...
import com.mouqukeji.hmdeer.receiver.ForceOfflineReceiver;
...
public class ForceOfflineService  extends Service {
    ...
    public void onCreate() {
        ...
        intentFilter.addAction("com.mouqukeji.hmdeer");
        forceOfflineReceiver=new ForceOfflineReceiver();
        registerReceiver(forceOfflineReceiver, intentFilter);

        Intent intent =new Intent("com.mouqukeji.hmdeer");
