...
public class SendAddressRecyclerviewAdapter extends BaseQuickAdapter<Object, BaseViewHolder> {

    private int mSelectedPos=0;//保存当前选中的position
    public SendAddressRecyclerviewAdapter(int layoutResId, @Nullable List<Object> data) {
