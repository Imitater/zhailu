...
public class CancelledOrderRecyclerviewAdapter extends BaseQuickAdapter<AllOrderBean.TasksBean, BaseViewHolder> {

    public CancelledOrderRecyclerviewAdapter(int layoutResId, @Nullable List<AllOrderBean.TasksBean> data) {
