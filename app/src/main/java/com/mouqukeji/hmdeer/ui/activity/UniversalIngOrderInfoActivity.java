...
import com.mouqukeji.hmdeer.contract.activity.UniversalIngOrderInfoContract;
import com.mouqukeji.hmdeer.modle.activity.UniversalIngOrderInfoModel;
import com.mouqukeji.hmdeer.presenter.activity.UniversalIngOrderPresenter;
...
public class UniversalIngOrderInfoActivity extends BaseActivity<UniversalIngOrderPresenter, UniversalIngOrderInfoModel> implements UniversalIngOrderInfoContract.View, View.OnClickListener {
    ...
    public static UniversalIngOrderInfoActivity instance = null;
            ...
            switch (msg.what) {
                case SDK_PAY_FLAG: {
                    ...
                    if (TextUtils.equals(resultStatus, "9000")) {
                        ...
                        Toast.makeText(UniversalIngOrderInfoActivity.this, "支付成功", Toast.LENGTH_SHORT).show();
                        Intent intent = new Intent(UniversalIngOrderInfoActivity.this, PayInfoCompleteActivity.class);
                        intent.putExtra("task_id", taskId);
                        intent.putExtra("cate_id", cate_id);
                        startActivityForResult(intent, 5);
                    } else {
                        // 该笔订单真实的支付结果，需要依赖服务端的异步通知。
                        Toast.makeText(UniversalIngOrderInfoActivity.this, "支付失败", Toast.LENGTH_SHORT).show();
                    }
                    break;
                }
                default:
    ...
    protected int setLayoutResourceID() {
        return R.layout.activity_universalingorder_info;
    }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.orderinfo_bottom_bt:
                ...
                DialogUtils.processDialog(UniversalIngOrderInfoActivity.this, inflate_procress, true, true, infoBean);
                break;
            case R.id.takeing_bt:
                if (progress.equals("5") || progress.equals("6") || progress.equals("7")) {
                    ...
                    Intent intent = new Intent(UniversalIngOrderInfoActivity.this, EvaluationActivity.class);
            ...
            case R.id.orderinfo_bottom_tv:
                ...
                DialogUtils.processDialog(UniversalIngOrderInfoActivity.this, inflate_procress1, true, true, infoBean);
                break;
    ...
    private void setPay(final String pay_fee, final double balance, final String order_id) {
        ...
        dialogPayRecharge.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(UniversalIngOrderInfoActivity.this, ReChargeActivity.class);
