...
import com.mouqukeji.hmdeer.modle.activity.SendIngOrderInfoModel;
import com.mouqukeji.hmdeer.presenter.activity.SendIngOrderInfoPresenter;
...
public class SendIngOrderInfoActivity extends BaseActivity<SendIngOrderInfoPresenter, SendIngOrderInfoModel> implements SendIngOrderInfoContract.View, View.OnClickListener {
    ...
    public static SendIngOrderInfoActivity instance = null;
            ...
            switch (msg.what) {
                case SDK_PAY_FLAG: {
                    ...
                    if (TextUtils.equals(resultStatus, "9000")) {
                        ...
                        Toast.makeText(SendIngOrderInfoActivity.this, "支付成功", Toast.LENGTH_SHORT).show();
                        Intent intent = new Intent(SendIngOrderInfoActivity.this, PayInfoCompleteActivity.class);
                        intent.putExtra("task_id", taskId);
                        intent.putExtra("cate_id", cate_id);
                        startActivityForResult(intent, 3);
                    } else {
                        // 该笔订单真实的支付结果，需要依赖服务端的异步通知。
                        Toast.makeText(SendIngOrderInfoActivity.this, "支付失败", Toast.LENGTH_SHORT).show();
                    }
                    break;
                }
                default:
    ...
    protected int setLayoutResourceID() {
        return R.layout.activity_sendingorder_info;
    }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.orderinfo_bottom_bt:
                ...
                DialogUtils.processDialog(SendIngOrderInfoActivity.this, inflate_procress, true, true, sendInfoBean);
                break;
            case R.id.orderinfo_bottom_tv:
                //进程显示框
                View inflate_procress1 = getLayoutInflater().inflate(R.layout.dialog_procress, null);
                DialogUtils.processDialog(SendIngOrderInfoActivity.this, inflate_procress1, true, true, sendInfoBean);
                break;
            case R.id.takeing_bt:
                if (progress.equals("5") || progress.equals("6") || progress.equals("7")) {
                    ...
                    Intent intent = new Intent(SendIngOrderInfoActivity.this, EvaluationActivity.class);
    ...
    private void setPay(final String pay_fee, final double balance, final String order_id) {
        ...
        dialogPayRecharge.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(SendIngOrderInfoActivity.this, ReChargeActivity.class);
