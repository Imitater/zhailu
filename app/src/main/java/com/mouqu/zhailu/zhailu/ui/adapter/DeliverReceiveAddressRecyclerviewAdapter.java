...
public class DeliverReceiveAddressRecyclerviewAdapter extends BaseQuickAdapter<Object, BaseViewHolder> {

    private int mSelectedPos=0;//保存当前选中的position
    public DeliverReceiveAddressRecyclerviewAdapter(int layoutResId, @Nullable List<Object> data) {
