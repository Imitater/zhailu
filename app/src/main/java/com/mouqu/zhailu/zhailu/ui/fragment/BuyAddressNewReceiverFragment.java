...
import com.mouqu.zhailu.zhailu.contract.fragment.BuyAddressNewReceiverContract;
import com.mouqu.zhailu.zhailu.modle.fragment.BuyAddressNewReceiverModel;
import com.mouqu.zhailu.zhailu.presenter.fragment.BuyAddressNewReceiverPresenter;
import com.mouqu.zhailu.zhailu.ui.activity.SelectBuyAddressActivity;

import butterknife.BindView;


public class BuyAddressNewReceiverFragment extends BaseFragment<BuyAddressNewReceiverPresenter, BuyAddressNewReceiverModel> implements BuyAddressNewReceiverContract.View, View.OnClickListener{
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.address_tv_address:
                Intent intent = new Intent(getMContext(), SelectBuyAddressActivity.class);//选择地址
