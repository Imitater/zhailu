...
import com.mouqu.zhailu.zhailu.ui.fragment.ToPayFragment;

import java.util.List;

public class ToPayRecyclerviewAdapter extends BaseQuickAdapter<AllOrderBean.TasksBean, BaseViewHolder> {

    public ToPayRecyclerviewAdapter(int layoutResId, ToPayFragment toPayFragment, @Nullable List<AllOrderBean.TasksBean> data) {
