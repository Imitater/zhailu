...
import com.mouqu.zhailu.zhailu.contract.activity.DeliverOrderInfoContract;
import com.mouqu.zhailu.zhailu.modle.activity.DeliverOrderInfoModel;
import com.mouqu.zhailu.zhailu.presenter.activity.DeliverOrderInfoPresenter;
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.orderinfo_bottom_bt:
                ...
                DialogUtils.processDialog(DeliverOrderInfoActivity.this, inflate_procress, true, true);
                break;
        }
    }
